...
date: 'October 9, 2021'
excerpt: 'In this article, we will see how to create a React application and configure to be able to use Typescript inside'
...
**For further information, check my [Github Project](https://github.com/WayToSync/typescriptwithreact)**
